...
- The measured gain is **backbone-specific**, and under the protocol budget the pattern is monotone: the default wiring's paired mAP50 mean falls from +0.0025 (YOLOv8n) through +0.0013 (11n) and −0.0018 (12n) to −0.0034 (26n) under the same data, budget and seeds. Compatibility across four generations is a statement about mechanics, not about accuracy; the earlier 20-epoch reading of 11n as "absent" did not survive the full budget (see `docs/JUDGMENT.md`).
