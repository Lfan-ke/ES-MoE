...
The 80 `best.pt` checkpoints behind the protocol matrix on `main` — seven backbones (YOLOv5n / v8n / v9t / v10n / 11n / 12n / 26n) × three arms (baseline / esmoe / esmoe-rewire) × three seeds, with five seeds on every YOLOv10n arm, VisDrone, imgsz 800, 120 epochs, `patience=0`, batch 32.
