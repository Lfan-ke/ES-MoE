...
<li><strong>Measured under the repository protocol</strong><span>Four backbone generations × three arms × three seeds, 36 runs: the default wiring's mAP50 decays monotonically from +0.0025 (v8n) to −0.0034 (26n); <code>rewire</code> pulls 12n and 26n back to parity. Full verdicts on the <a href="JUDGMENT/">judgment lines</a> page.</span></li>
</ul>
</div>
