...
<li><strong>按仓库协议量过</strong><span>七代主干 × 三臂 × 三 seed 共 77 轮：默认接法在 SPPF 系末端为正（v5n +0.0055、v8n +0.0025、v9t +0.0025），末端换成注意力块后贴零（v10n −0.0002、11n +0.0013），到 12n、26n 转负；<code>rewire</code> 把 12n、26n 拉回持平。判定全文见<a href="JUDGMENT/">判读线</a>。</span></li>
</ul>
</div>
